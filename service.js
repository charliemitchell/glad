...
function after_init_hook (callback, conf) {
    ...
    app_hook(hooks, server, app, express, function () {
        ...
        exposeGlobals(global, function () {
            ...
            before_mongoose_hook(mongoose, hooks, server, app, express, function () {
                ...
                before_body_parser_hook(hooks, server, app, express, function () {

                    app.use(require('body-parser')[config.bodyParser]({limit : config.maxBodySize || '1mb'}));

                    before_method_override_hook(hooks, server, app, express, function () {

                        app.use(require('method-override')());

                        before_cookie_parser_hook(hooks, server, app, express, function () {

                            app.use(cookieParser());

                            before_read_session_hook(hooks, server, app, express, function () {
                                ...
                                before_router_hook(hooks, server, app, express, function () {
